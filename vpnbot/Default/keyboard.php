...
// keyboard bot 
$keyboarddate = array(
    'text_sell' => ['text' => $text_bot_var['btn_keyboard']['buy'], 'style' => 'success'],
    'text_usertest' => ['text' => $text_bot_var['btn_keyboard']['test'], 'style' => 'primary'],
    'text_Purchased_services' => ['text' => $text_bot_var['btn_keyboard']['my_service'], 'style' => 'primary'],
    'accountwallet' => ['text' => $text_bot_var['btn_keyboard']['wallet'], 'style' => 'primary'],
    'text_support' => ['text' => $text_bot_var['btn_keyboard']['support']],
    'text_about' => ['text' => $text_bot_var['btn_keyboard']['about'] ?? '🏪 درباره فروشگاه'],
    'text_Admin' => ['text' => "👨‍💼 پنل مدیریت", 'style' => 'primary'],
);
...
foreach ($keyboarddate as $keyboardButton) {
    $tempArray[] = $keyboardButton;
