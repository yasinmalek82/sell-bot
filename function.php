...
require_once __DIR__ . '/lib/ResellerBotService.php';
require_once __DIR__ . '/lib/ResellerService.php';
require_once __DIR__ . '/lib/WalletService.php';
require_once __DIR__ . '/lib/TelegramKeyboard.php';
...
function select($table, $field, $whereField = null, $whereValue = null, $type = "select", $options = [])
{
    ...
    // If no PDO connection is available (SKIP_DB during local testing), return safe defaults
    if (!isset($pdo) || !($pdo instanceof PDO)) {
...
{
    // Allow bypass during local testing
    if (getenv('SKIP_IP_CHECK') === '1') {
        return true;
    }
...
function activecron()
{
    global $domainhosts, $disableSelfCron;

    if (!empty($disableSelfCron)) {
        return true;
    }
